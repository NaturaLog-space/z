...
#     os.system('/bin/bash -c "echo narwhale| sudo -S pkill openvpn &"')
#     time.sleep(2)
#     os.system('/bin/bash -c "echo narwhale| sudo -S openvpn us-sjc.prod.surfshark.com_udp.ovpn &"')
#     time.sleep(30)
